...
CREATE SEQUENCE  ETL_ERROR_LOG_SEQ  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;

CREATE OR REPLACE 
TRIGGER ETL_ERROR_LOG_TRG
BEFORE INSERT ON ETL_ERROR_LOG
FOR EACH ROW
BEGIN
    :NEW.ERROR_ID := ETL_ERROR_LOG_SEQ.NEXTVAL;
END;
